defmodule Newbee.Evolution.MetricsTest do
  ...
  test "从总线采集指标" do
    ...
    Newbee.Bus.emit(:usage, {:usage, %{"prompt_tokens" => 100, "uncached_prompt_tokens" => 20, "cache_read_tokens" => 80, "cache_write_tokens" => 10}})
    ...
    assert s.cache_hit_rate == (before.cache_read_tokens + 80) / (before.tokens_in + 120 + before.cache_read_tokens + 80 + before.cache_write_tokens + 10)
